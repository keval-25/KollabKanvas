...
public class BoardDto {
    ...
    public static BoardDto fromEntity(Board board, String currentUserId, String ownerName) {
        ...
        return BoardDto.builder()
                ...
                .createdAt(board.getCreatedAt() != null ? board.getCreatedAt() : Instant.now())
                .updatedAt(board.getUpdatedAt() != null ? board.getUpdatedAt() : (board.getCreatedAt() != null ? board.getCreatedAt() : Instant.now()))
